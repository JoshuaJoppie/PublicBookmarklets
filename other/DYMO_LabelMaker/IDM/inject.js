...
(function () {
    ...
    function w(a, b) {
        ...
        for (var g; d.length && (g = d.shift());) d.length || void 0 === b ? e[g] ? e = e[g] : e = e[g] = {} : e[g] = b
    }
    ...
    var B = Array.prototype,
        ...
        sa = B.forEach ? function (a, b, d) {
            ...
            for (var e = a.length, g = t(a) ? a.split("") : a, h = 0; h < e; h++) h in g && b.call(d, g[h], h, a)
        },
    ...
    function Ga(a, b) {
        for (var d, e, g = 1; g < arguments.length; g++) {
            e = arguments[g];
            for (d in e) a[d] = e[d];
            for (var h = 0; h < Fa.length; h++) d = Fa[h], Object.prototype.hasOwnProperty.call(e, d) && (a[d] = e[d])
        }
    }
    ...
    function F(a) {
        ...
        if (!(b = Pa[a])) {
            b = 0;
            for (var d = ma(String(Oa)).split("."), e = ma(String(a)).split("."), g = Math.max(d.length, e.length), h = 0; 0 == b && h < g; h++) {
                var k = d[h] || "",
                    l = e[h] || "",
                    m = RegExp("(\\d*)(\\D*)", "g"),
                    r = RegExp("(\\d*)(\\D*)", "g");
                do {
                    ...
                    b = oa(0 == J[1].length ? 0 : parseInt(J[1], 10), 0 == y[1].length ? 0 : parseInt(y[1], 10)) || oa(0 == J[2].length, 0 == y[2].length) || oa(J[2], y[2])
                } while (0 == b)
            }
            b = Pa[a] = 0 <= b
        }
    ...
    function pb() {
        if (p.Promise && p.Promise.resolve) {
            ...
            var a = rb;
            !u(p.setImmediate) || p.Window && p.Window.prototype && p.Window.prototype.setImmediate == p.setImmediate ? (lb || (lb = mb()), lb(a)) : p.setImmediate(a)
        }
    }
    var qb = !1,
        jb = new function () {
    ...
    function Eb(a, b) {
        if (a.c == sb)
            if (a.h) {
                var d = a.h;
                if (d.f) {
                    for (var e = 0, g = null, h = null, k = d.f; k && (k.l || (e++, k.c == a && (g = k), !(g && 1 < e))); k = k.next) g || (h = k);
    ...
    function $b(a, b, d, e, g, h) {
        ...
        b = a.c[k];
        b || (b = a.c[k] = [], a.f++);
        var l = ac(b, d, g, h); - 1 < l ? (a = b[l], e || (a.$ = !1)) : (a = new Xb(d, a.src, k, !!g, h), a.$ = e, b.push(a));
        return a
    }
        ...
        if (null == b) d.push("null");
            ...
            if ("object" == typeof b) {
                ...
                if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                    ...
                    d.push("{");
                    g = "";
                    for (e in b) Object.prototype.hasOwnProperty.call(b, e) && (h = b[e], "function" != typeof h && (d.push(g), vc(e, d), d.push(":"), tc(a, h, d), g = ","));
                    d.push("}");
                    return
                }
            }
    ...
    function Cc(a) {
        ...
        if (a.h != a.c.length) {
            for (var g = {}, d = b = 0; b < a.c.length;) e = a.c[b], Dc(g, e) || (a.c[d++] = e, g[e] = 1), b++;
            a.c.length = d
        }
    }
    ...
    function Zc(a) {
        if ($c) {
            ...
            if (b) {
                var d = b.href;
                if (d && (d = (d = Zc(d)[3] || null) ? decodeURI(d) : d) && d != b.hostname) throw $c = !0, Error();
            }
        }
        return a.match(Yc)
    }
    ...
    n.L = function () {
        "undefined" != typeof aa && this.c && (this.m = "Timed out after " + this.i + "ms, aborting", L(this.v, M(this, this.m)), K(this, "timeout"), this.c && this.f && (L(this.v, M(this, "Aborting")), this.f = !1, this.h = !0, this.c.abort(), this.h = !1, K(this, "complete"), K(this, "abort"), nd(this)))
    };
    ...
    n.K = function () {
        this.c && (this.f && (this.f = !1, this.h = !0, this.c.abort(), this.h = !1), nd(this, !0));
        cd.ca.K.call(this)
    };
    n.ha = function () {
    ...
    function rd(a) {
        ...
        if (!d) {
            if (b = 0 === b) a = Zc(String(a.o))[1] || null, !a && self.location && (a = self.location.protocol, a = a.substr(0, a.length - 1)), b = !gd.test(a ? a.toLowerCase() : "");
            d = b
        }
        return d
    }
    ...
    N.prototype.toString = function () {
        ...
        if (b = this.f) this.c && "/" != b.charAt(0) && a.push("/"), a.push(yd(b, "/" == b.charAt(0) ? Ad : Bd, !0));
    ...
    function yd(a, b, d) {
        return t(a) ? (a = encodeURI(a).replace(b, Hd), d && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
    }
    ...
    function Id(a) {
        a.c || (a.c = new Ac, a.h = 0, a.f && ad(a.f, function (b, d) {
    ...
    n.J = function (a) {
        ...
        if (t(a)) {
            ...
            for (a = this.c.J(), d = 0; d < a.length; d++) b = ya(b, a[d]);
        return b
    };
    ...
    n.toString = function () {
        ...
        for (var a = [], b = this.c.I(), d = 0; d < b.length; d++)
            for (var e = b[d], g = encodeURIComponent(String(e)), e = this.J(e), h = 0; h < e.length; h++) {
                var k = g;
    ...
    function Dd(a, b) {
        b && !a.i && (Id(a), a.f = null, a.c.forEach(function (a, b) {
            var g = b.toLowerCase();
    ...
    function Qd() {
        return "undefined" !== typeof window.localStorage && window.localStorage ? window.localStorage : null
    }
    ...
    function Rd(a, b) {
        ...
        if (d)
            ...
            } catch (e) {} else Nd() ? a && b ? (Od("ServicePort", a, 100), Od("ServiceHost", b, 100)) : (Od("ServicePort", "", 100), Od("ServiceHost", "", 100)) : (window.f = a, window.c = b)
    }
    ...
    function Td(a, b, d) {
        ...
        if ("undefined" !== typeof XMLHttpRequest) e = new XMLHttpRequest;
            ...
            for (var g, h = 0; h < e.length; h++) try {
    ...
    function Ud(a, b) {
        ...
        g ? jd("https://" + e + ":" + g + "/DYMO/DLS/Printing/StatusConnected", function (b) {
            rd(b.target) ? a() : (Rd(null, null), Vd("127.0.0.1", a, d))
        }, "GET", void 0, 3E3) : Vd("127.0.0.1", a, d)
    }
    ...
    function Yd(a, b) {
        try {
            return "true" === Td("https://" + b + ":" + a + "/DYMO/DLS/Printing/StatusConnected", {}, "GET")
        } catch (d) {
            return !1
        }
    }
        ...
        return new G(function (e, k) {
            ...
            jd(g, function (a) {
                ...
                if (rd(d)) {
                    ...
                    e(a)
                } else a = "Failed to execute webservice command: " + b + ". Error: " + d.w(), O("invokeWsCommandAsync > " + a), k(Error(a))
            }, a || "GET", m, 1E4)
        })
    }
    ...
    function be() {
        ...
        this.loadImageAsPngBase64 = function (a) {
            return ae("GET", "LoadImageAsPngBase64", {
                imageUri: a
            })
        };
        this.T = function () {
        ...
        this.U = function (a) {
            return $d("GET", "LoadImageAsPngBase64", {
                imageUri: a
            })
        }
    };
        ...
        switch (d.tagName) {
            ...
            case "ImageObject":
                ...
                if (e) V(e, b);
                    ...
                    if (!g) throw Error("setObjectText(): <ImageLocation> is expected but not found: " + ie(e));
    ...
    */
    ...
    function Ce(a) {
        ...
        for (var b = a.h, e = d = !1; a.l.length && !a.o;) {
            ...
            if (h = a.i ? k : h) try {
                ...
                if (cb(b) || "function" === typeof p.Promise && b instanceof p.Promise) e = !0, a.o = !0
            } catch (m) {
                b = m, a.i = !0, Fe(a) || (d = !0)
            }
        }
    ...
    function Ie(a, b) {
        ...
        g.onload = g.onreadystatechange = function () {
            g.readyState && "loaded" != g.readyState && "complete" != g.readyState || (Ke(g, d.xa || !1, l), Ae(k), Be(k, !0, null))
        };
        g.onerror = function () {
            Ke(g, !0, l);
    ...
    function ff(a) {
        ...
        if (a.isWebServicePresent) {
            ...
            if (d) a = {
                ...
                getJobStatus: function (a, b) {
                    var e;
                    u(d.getJobStatus) ? e = Ye(d.getJobStatus(a, parseInt(b, 10))) : e = {
                        status: Q.S,
        ...
        if ("ActiveXObject" in window) {
            ...
            a.getJobStatus =
                function (a, b) {
                    var d;
                    u(e.GetJobStatus) ? d = Ye(e.GetJobStatus(a, parseInt(b, 10))) : d = {
                        status: Q.S,
                        statusMessage: "not implemented"
                    };
            ...
            if (g) a = {
                ...
                getJobStatus: function (a, b) {
                    var d;
                    u(g.getJobStatus) ? d = Ye(g.getJobStatus(a, parseInt(b, 10))) : d = {
                        status: Q.S,
                        statusMessage: "not implemented"
                    };
                    return new Xe(a, b, d.status, d.statusMessage)
            ...
            if (h) a = {
                ...
                getJobStatus: function (a, b) {
                    var d;
                    u(h.getJobStatus) ? d = Ye(h.getJobStatus(a, parseInt(b, 10))) : d = {
                        status: Q.S,
                        statusMessage: "not implemented"
                    };
                    return new Xe(a, b, d.status, d.statusMessage)
    ...
    var P = function () {
        function a(g, h) {
            ...
            return b ? (O("_createFramework > returning existing instance of _framework, has callBack: " + !!g), g && g(e), b) : this && this.constructor == a ? (d = !0, P.c = function () {
                e = b = null;
                Xd = 0
            }, hf(function (a) {
                e = a;
    ...
    function rf() {
        var a = [];
        a.byIndex = [];
        Object.defineProperty(a, "byIndex", {
            enumerable: !1,
            value: []
        });
        return a
    ...
    function sf(a, b) {
        ...
        b.push(a);
        b.byIndex.push(a);
        d.match(/^\d+$/) && console.error("Printer name consisting of numbers only (" + d + ') will break proper array behavior. Consider using "byIndex" property for accessing elements by index reliably.');
        "length" === d && console.error('Using "length" as printer name overrides Array.length property!');
        b[d] = a
    }
    ...
    function pe(a, b, d, e) {
        ...
        return vf().then(function (g) {
            var h = g[a];
            if (null != h) return "" != h.C ? yf(h, b, d, e) : P().W(a, b, d, e).then(function (a) {
                return new Z(h, a)
            });
...
function getprovar(namee) {
    if (namee == "building") {

        var bvar = jQuery("#roles :contains('School')").filter('th, td').filter(':not([colspan])').closest('table').find('tr').filter(':not(:has([colspan]))')[1].cells[1].innerText.trim();
        console.log("bvar=:::" + bvar);
        var arrr = [100013217,100005085,100013043,100008045,100006542,100004263,100015345,100008691,100007606,100016511,100014346,100014365,100014368,100014066,100014069,100014310,100006284,100008104,100006521,100004456,100008057,100006530,100007928,100002728,100008899,100005546,100015031,100015022,100014184,100015206,100008942,100010535,100009961,100009910,100015122,100013315,100003106,100012214,100006553,100006557,100011262,100006559,100016541,100007038,100007630,100007825,100016285,100015123,100013725,100010622,100008666,100014787,100014786,100014698,100014714,100011270,100013797,100013981,100005065,100007762,100002729,100006616,100006575,100004435,100007368,100014050,100014284,100005123,100010652,100006862,100008543,100007638,100005201,100005050,100004522,100007738,100012620,100004478,100015040,100004369,100008637,100012784,100014832,100005126,100006766,100006765,100015006,100011170,100013392,100006734,100006388,100004865,100004969,100006773,100006809,100007640,100014182,100012903,100009268,100008103,100006427,100013616,100012430,100004498,100004499,100015155,100012634,100016423,100004040,100006257,100004506,100005163,100005994,100003870,100011557,100012517,100004291,100008636,100004508,100008082,100003019,100009449,100002817,100009032,100007812,100003949,100007590,100009004,100016196,100010936,100008874,100014068,100014067,100008602,100007351,100015021,100014183,100006137,100004010,100016092,100004406,100006496,100007869,100007597,100012312,100008985,100004951,100015196,100011765,100016086,100015799,100007448,100004609];
        if (bvar == "Holland High School") {
            if (arrr.indexOf(getprovar("Number")) > -1) {
        ...
        switch (bvar) {
            ...
            default:
                {
                    var bbvar = prompt("Building code?", "HHS or HEC or Anything else?");
                    return bbvar;
                }
        }
    } else {

        var bvar = jQuery("td.display-label:contains('" + namee + "')").last()[0].nextElementSibling.innerText.trim();
        return bvar;
    }
}

function twinprint(printerName, side, label, quality) {
    var params = {};
    params.jobTitle = "Device Student Label";
    params.twinTurboRoll = side;
    params.printQuality = quality;
    var printParamsXml = dymo.label.framework.createLabelWriterPrintParamsXml({
        twinTurboRoll: params.twinTurboRoll,
        jobTitle: params.jobTitle,
        printQuality: params.printQuality
    });
    console.log(params);
    console.log(printParamsXml);
    console.log(label);
    dymo.label.framework.printLabel(printerName, printParamsXml, label);
}


function onSuccessor(labelVars) {
    console.log("PRINTER VARS LABEL VARS:::" + labelVars);
    console.log("PRINTER VARS LABEL VARS:STRING::" + JSON.stringify(labelVars));
    //var labelXml = labelVars.xml;
    //labelVars.xml = "";
    var parser = new DOMParser();
    var xmlDoc = parser.parseFromString(labelVars.xml, "text/xml");
    var xmlstring = new XMLSerializer().serializeToString(xmlDoc);
    var labeler = dymo.label.framework.openLabelXml(xmlstring);
    //labelVars.xml = "";
    if (labelVars.blended == "YES") {
        labeler.setObjectText("TITLE", labelVars.title);
        labeler.setObjectText("SUBTITLE", labelVars.subtitle);
        labeler.setObjectText("CERTVAR", labelVars.certvar);
        labeler.setObjectText("FIRSTNAME", labelVars.firstname);
        labeler.setObjectText("LASTNAME", labelVars.lastname);
    } else {
        labeler.setObjectText("NAME", labelVars.name);
    }
    labeler.setObjectText("building", labelVars.building);
    labeler.setObjectText("gradyear", labelVars.gradyear);
    labeler.setObjectText("username", labelVars.username);
    twinprint(labelVars.printerName, dymo.label.framework.TwinTurboRoll.Left, labeler, labelVars.printQuality);
}
...
function getLabel() {
    ...
    //avar.xml = "";
    avar.blended = "NO";
    avar.printerName = "DYMO LabelWriter 450 Twin Turbo";
    avar.printQuality = "Auto";
    avar.building = getprovar("building");
    avar.gradyear = getprovar("Grad Year");
    avar.username = getprovar("Account");
    avar.password = getprovar("Password");
    if (avar.blended == "YES") {
        avar.xml = "";
        avar.firstname = getprovar("First");
        avar.lastname = getprovar("Last");
        avar.title = "";
        avar.subtitle = "";
        avar.certvar = "";
    } else {
        avar.xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n<DieCutLabel Version=\"8.0\" Units=\"twips\"><PaperOrientation>Landscape<\/PaperOrientation><Id>Address<\/Id><IsOutlined>false<\/IsOutlined><PaperName>30252 Address<\/PaperName><DrawCommands><RoundRectangle X=\"0\" Y=\"0\" Width=\"1581\" Height=\"5040\" Rx=\"270\" Ry=\"270\" \/><\/DrawCommands><ObjectInfo><BarcodeObject><Name>username<\/Name><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" \/><BackColor Alpha=\"0\" Red=\"255\" Green=\"255\" Blue=\"255\" \/><LinkedObjectName \/><Rotation>Rotation0<\/Rotation><IsMirrored>False<\/IsMirrored><IsVariable>True<\/IsVariable><GroupID>-1<\/GroupID><IsOutlined>False<\/IsOutlined><Text>MAGRADA<\/Text><Type>Code128Auto<\/Type><Size>Small<\/Size><TextPosition>None<\/TextPosition><TextFont Family=\"Arial\" Size=\"7.3125\" Bold=\"False\" Italic=\"False\" Underline=\"False\" Strikeout=\"False\" \/><CheckSumFont Family=\"Arial\" Size=\"7.3125\" Bold=\"False\" Italic=\"False\" Underline=\"False\" Strikeout=\"False\" \/><TextEmbedding>None<\/TextEmbedding><ECLevel>0<\/ECLevel><HorizontalAlignment>Left<\/HorizontalAlignment><QuietZonesPadding Left=\"0\" Top=\"0\" Right=\"0\" Bottom=\"0\" \/><\/BarcodeObject><Bounds X=\"1291\" Y=\"785.31494140625\" Width=\"3480.47265625\" Height=\"600.708679199219\" \/><\/ObjectInfo><ObjectInfo><TextObject><Name>NAME<\/Name><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" \/><BackColor Alpha=\"0\" Red=\"255\" Green=\"255\" Blue=\"255\" \/><LinkedObjectName \/><Rotation>Rotation0<\/Rotation><IsMirrored>False<\/IsMirrored><IsVariable>True<\/IsVariable><GroupID>-1<\/GroupID><IsOutlined>False<\/IsOutlined><HorizontalAlignment>Left<\/HorizontalAlignment><VerticalAlignment>Middle<\/VerticalAlignment><TextFitMode>AlwaysFit<\/TextFitMode><UseFullFontHeight>True<\/UseFullFontHeight><Verticalized>False<\/Verticalized><StyledText><Element><String xml:space=\"preserve\">Joppie, Joshua<\/String><Attributes><Font Family=\"Helvetica\" Size=\"18\" Bold=\"True\" Italic=\"False\" Underline=\"False\" Strikeout=\"False\" \/><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" HueScale=\"100\" \/><\/Attributes><\/Element><\/StyledText><\/TextObject><Bounds X=\"331\" Y=\"57.9999999999999\" Width=\"4333.11267605634\" Height=\"736.30985915493\" \/><\/ObjectInfo><ObjectInfo><TextObject><Name>gradyear<\/Name><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" \/><BackColor Alpha=\"0\" Red=\"255\" Green=\"255\" Blue=\"255\" \/><LinkedObjectName \/><Rotation>Rotation0<\/Rotation><IsMirrored>False<\/IsMirrored><IsVariable>True<\/IsVariable><GroupID>-1<\/GroupID><IsOutlined>False<\/IsOutlined><HorizontalAlignment>Left<\/HorizontalAlignment><VerticalAlignment>Middle<\/VerticalAlignment><TextFitMode>ShrinkToFit<\/TextFitMode><UseFullFontHeight>True<\/UseFullFontHeight><Verticalized>False<\/Verticalized><StyledText><Element><String xml:space=\"preserve\">2024<\/String><Attributes><Font Family=\"Helvetica\" Size=\"15\" Bold=\"True\" Italic=\"False\" Underline=\"False\" Strikeout=\"False\" \/><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" HueScale=\"100\" \/><\/Attributes><\/Element><\/StyledText><\/TextObject><Bounds X=\"346\" Y=\"1056.69014084507\" Width=\"1183.11267605634\" Height=\"376.30985915493\" \/><\/ObjectInfo><ObjectInfo><TextObject><Name>building<\/Name><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" \/><BackColor Alpha=\"0\" Red=\"255\" Green=\"255\" Blue=\"255\" \/><LinkedObjectName \/><Rotation>Rotation0<\/Rotation><IsMirrored>False<\/IsMirrored><IsVariable>True<\/IsVariable><GroupID>-1<\/GroupID><IsOutlined>False<\/IsOutlined><HorizontalAlignment>Left<\/HorizontalAlignment><VerticalAlignment>Middle<\/VerticalAlignment><TextFitMode>ShrinkToFit<\/TextFitMode><UseFullFontHeight>True<\/UseFullFontHeight><Verticalized>False<\/Verticalized><StyledText><Element><String xml:space=\"preserve\">HHS<\/String><Attributes><Font Family=\"Helvetica\" Size=\"15\" Bold=\"True\" Italic=\"False\" Underline=\"False\" Strikeout=\"False\" \/><ForeColor Alpha=\"255\" Red=\"0\" Green=\"0\" Blue=\"0\" HueScale=\"100\" \/><\/Attributes><\/Element><\/StyledText><\/TextObject><Bounds X=\"346\" Y=\"756.69014084507\" Width=\"1183.11267605634\" Height=\"376.30985915493\" \/><\/ObjectInfo><\/DieCutLabel>";
        avar.name = getprovar("Last") + ", " + getprovar("First");
    }
    console.log(avar);
